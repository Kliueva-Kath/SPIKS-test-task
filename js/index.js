...
document.addEventListener('DOMContentLoaded', function () {
  ...
  */
  ...
  function adjustInputWidth(input) {
    ...
    if ((input.id === 'thc-to' || input.id === 'cbd-to') && Number(value) > 100) {
      input.value = 100;
  ...
  accordionItems.forEach(function (item) {
    ...
    header.addEventListener('click', function () {
      ...
      if (!document.querySelector('.filters-accordion__item.active')) {
        document.querySelector('.filters-accordion__background').classList.add('small');
      } else {
        document.querySelector('.filters-accordion__background').classList.remove('small');
      }
    });
  });
  ...
  function updateSelectedFilters() {
    ...
    document.querySelectorAll('.filter__cancel-btn').forEach(function (btn) {
      btn.addEventListener('click', function (event) {
        ...
        var correspondingCheckbox = Array.from(checkboxes).find(function (checkbox) {
  ...
  noUiSlider.create(thcSlider, (_noUiSlider$create = {
    start: 65,
    connect: true,
    tooltips: {
      to: function to(value) {
    ...
    step: 1
  }, _defineProperty(_noUiSlider$create, "connect", [true, false]), _defineProperty(_noUiSlider$create, "format", {
    to: function to(value) {
      return Math.round(value);
    },
    from: function from(value) {
  ...
  noUiSlider.create(cbdSlider, (_noUiSlider$create2 = {
    start: 65,
    connect: true,
    tooltips: {
      to: function to(value) {
    ...
    step: 1
  }, _defineProperty(_noUiSlider$create2, "connect", [true, false]), _defineProperty(_noUiSlider$create2, "format", {
    to: function to(value) {
      return Math.round(value);
    },
    from: function from(value) {
